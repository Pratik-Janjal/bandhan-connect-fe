...
const Register: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setIsLoading(true);
    try {
      const { confirmPassword, date_of_birth, ...rest } = formData;
      const [year, month, day] = date_of_birth.split("-");
      const formattedDOB = `${day}-${month}-${year}`;
      const dataToSend = {...rest, date_of_birth : formattedDOB}
        ...
        <div className="card p-8">
            ...
            <div>
              <label className="flex items-start">
                ...
                <span className="ml-2 text-sm text-gray-600">
                  I agree to the{' '}
                  <Link to="/terms" className="text-saffron hover:text-orange-600">
                    Terms of Service
                  </Link>
                  and
                  <Link to="/privacy" className="text-saffron hover:text-orange-600">
                    Privacy Policy
                  </Link>
                </span>
              </label>
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-600">
              ...
              <Link to="/login" className="text-saffron hover:text-orange-600 font-medium">
                Sign in
              </Link>
            </p>
          </div>
